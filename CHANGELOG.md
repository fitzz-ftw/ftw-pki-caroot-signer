...
### Added
- Register the new getting started guide directly within the main documentation index tree (`index_get_started.rst`).

### Changed
- Refactor and finalize the module structure to support deployment as a standalone intermediate signer package (`ftwpkicarootsigner`).
- Update programmatic API and layout mappings inside the Sphinx development documentation suite.
